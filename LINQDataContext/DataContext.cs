    ...
    public class DataContext
    {
        ...
        public DataContext()
        {
            ...
            this.Students.AddRange(new Student[] {
                ...
                new Student(){ Student_ID = 26, First_Name = "Darren", Last_Name = "Aronofsky", BirthDate = new DateTime(1969,02,12), Login = "darono", Section_ID = 1010, Year_Result = 17, Course_ID = "EG2210"}
            });
